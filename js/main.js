		...
		$.ajax('http://registry.jsonresume.org/competition', {
			success: function (data) {
				...
				_.each(themes, function(theme){
					...
					row.append($('<td/>').html('<a target="_blank" href="https://twitter.com/intent/tweet?related=jsonresume,thomasdavis,erming&text=I%20vote%20for%20the%20%23'+theme.slug+'%20resume%20theme%20to%20win%20this%20months%20%24250%20prize%20at%20jsonresume.org%2Fthemes">Tweet your vote</a>'));
					tbody.append(row);
					rank++;
				});
			}
